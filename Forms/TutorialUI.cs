...
namespace Class_Manager.Forms 
{
    ...
    //Another List of the type Image will be used to display the appropriate image.
    public partial class TutorialUIFrm : Form
    {   
        private readonly User user;
        public int pagenum = 0;
        public List<string> TutorialText = new();
        public List<Image> TutorialImages = new();
        public TutorialUIFrm(User u)
        {
            ...
            TutorialImages.Add(Resources.Start);
            TutorialImages.Add(Resources.AddClass);
            TutorialImages.Add(Resources.AddAssign);
            TutorialImages.Add(Resources.AddFile);
            TutorialImages.Add(Resources.End);
        ...
        {
            //Sets the initial text in the TutorialBox and initial picture in TutorialPicture.
            TutorialBox.Text = TutorialText[pagenum];
            TutorialPicture.Image = Resources.Demo1;
            ...
            if (pagenum >= 3) 
            {
                ...
                TutorialBox.Text = TutorialText[pagenum];
                TutorialPicture.Image = TutorialImages[pagenum];
            }
            //Normal page advancement, change text to current TutorialText index using pagenum.
            //Change picture to current TutorialImages index using pagenum.
            else
            {
